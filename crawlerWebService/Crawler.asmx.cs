...
namespace crawlerWebService {
    ...
    public class Crawler : System.Web.Services.WebService {
        // DEBUG
        ...
        private static int controlThreadTimeout = 100000;
        ...
        // Control methods
        public static string[] testCrawl() {
            // get a new crawlID
            try {
                int val = 0;
